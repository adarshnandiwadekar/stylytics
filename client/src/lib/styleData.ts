...
export const OCCASIONS = ["casual", "work", "date", "party", "wedding", "travel", "everyday"] as const;
...
export function readState(): AppState {
  ...
  try {
    ...
    return { ...defaultState, ...parsed, items: parsed.items?.length ? parsed.items : DEMO_ITEMS };
  } catch {
    return defaultState;
  }
}
